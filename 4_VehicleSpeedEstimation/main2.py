...
plt.subplot(2, 1, 1)
plt.bar(range(len(time_list_down)), distance_list_down, align='center', alpha=0.7)
plt.xticks(range(len(time_list_down)), [f'{t:.2f}' for t in time_list_down])
plt.title('Distance vs Elapsed Time Bar Graph for Vehicles Going Down')
plt.xlabel('Elapsed Time (seconds)')
plt.ylabel('Distance (meters)')
plt.subplot(2, 1, 2)
plt.bar(range(len(time_list_up)), distance_list_up, align='center', alpha=0.7)
plt.xticks(range(len(time_list_up)), [f'{t:.2f}' for t in time_list_up])
plt.title('Distance vs Elapsed Time Bar Graph for Vehicles Going Up')
plt.xlabel('Elapsed Time (seconds)')
plt.ylabel('Distance (meters)')
plt.tight_layout()
plt.show()

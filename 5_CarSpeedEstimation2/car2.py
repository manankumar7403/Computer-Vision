...
cap = cv2.VideoCapture('veh2_30fps_1080.mp4')
...
while True:
    ...
    #pts = np.array([[336, cy1], [670, cy1], [713, cy2], [286, cy2]], np.int32)
    #pts = pts.reshape((-1, 1, 2))
    #cv2.fillPoly(frame, [pts], (128, 0, 0))
    #_________________________________________________
    
    cv2.line(frame, (336, cy1), (670, cy1), (0, 255, 0), 1)
    cv2.putText(frame, ('LINE 1'), (338, 376), cv2.FONT_HERSHEY_COMPLEX, 0.6, (255, 255, 255), 2)
    cv2.line(frame, (286, cy2), (713, cy2), (0, 255, 0), 1)
    cv2.putText(frame, ('LINE 2'), (294, 419), cv2.FONT_HERSHEY_COMPLEX, 0.6, (255, 255, 255), 2)

    length_down = (len(counter))
    cv2.putText(frame, ('Car Down:') + str(length_down), (83, 198), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255),2)

    length_up = (len(counter1))
    cv2.putText(frame, ('Car Up:') + str(length_up), (82, 293), cv2.FONT_HERSHEY_COMPLEX, 0.8, (255, 255, 255), 2)

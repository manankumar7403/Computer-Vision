...
cap = cv2.VideoCapture('veh3_30fps.mp4')
...
while True:
    ...
    #pts = np.array([[61, cy1], [635, cy1], [654, cy2], [5, cy2]], np.int32)
    #pts = pts.reshape((-1, 1, 2))
    #cv2.fillPoly(frame, [pts], (128, 0, 0))
    #_________________________________________________
    
    cv2.line(frame, (61, cy1), (635, cy1), (0, 255, 255), 1)
    cv2.putText(frame, ('LINE 1'), (60, 302), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 0), 2)
    cv2.line(frame, (5, cy2), (654, cy2), (0, 255, 255), 1)
    cv2.putText(frame, ('LINE 2'), (12, 327), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 0), 2)

    length_down = (len(counter))
    cv2.putText(frame, ('Car Down:') + str(length_down), (118, 72), cv2.FONT_HERSHEY_COMPLEX, 0.8, (0, 0, 0),2)

    length_up = (len(counter1))
    cv2.putText(frame, ('Car Up:') + str(length_up), (107, 147), cv2.FONT_HERSHEY_COMPLEX, 0.8, (0, 0, 0), 2)
